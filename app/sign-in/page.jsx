    ...
    <main className="min-h-screen bg-slate-50 px-6 py-10">
      <div className="mx-auto flex max-w-md flex-col items-center">
        ...
        <section className="mt-8 w-full rounded-lg border border-slate-200 bg-white p-6 shadow-sm sm:p-8">
          <p className="text-xs font-semibold uppercase tracking-[0.22em] text-orange-600">Welcome back</p>
          <h1 className="mt-3 text-3xl font-semibold text-slate-950">Sign in</h1>
          <p className="mt-2 text-sm leading-6 text-slate-500">
            Access your orders, saved addresses, wishlist, and faster checkout.
          </p>
        ...
        <div className="mt-6 w-full">
          ...
          <Link
            href="/sign-up"
            className="mt-4 block w-full rounded-lg border border-slate-300 bg-white px-4 py-3 text-center text-sm font-medium text-slate-700 transition hover:border-orange-300 hover:bg-orange-50"
          >
            Create your RajGharana account
          </Link>
        </div>
